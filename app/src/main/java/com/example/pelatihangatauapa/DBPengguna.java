...
public class DBPengguna extends SQLiteAssetHelper {
    ...
    public void save (Pengguna pengguna)
    {
        ...
        values.put(KEY_NIM, pengguna.getNim());
        values.put(KEY_NAMA,pengguna.getNama_nama());
        values.put(KEY_PRODI,pengguna.getProgramstudi());
        values.put(KEY_TAHUN,pengguna.getTahunmasuk());
        values.put(KEY_STATUS,pengguna.getStatus());
        values.put(KEY_STATUS,pengguna.getStatus());
